...
> Auto-generated by `pipeline/lib/gaps.py`. Regenerated: **2026-07-21 14:17:37**.
> Source: `pipeline-state/gaps/<slug>.md` (written by integrate/verify stages).

| Bucket | Markers | Count |
|---|---|--:|
| docs-mcp | coverageGap / staleness / docsEscape | 11 / 5 / 4 |
| skills | missedTrigger / falseTrigger / variant / hallucination | 15 / 3 / 0 / 2 |
| sdk | SDK-gap (packaging / behaviour) | 24 |
