...
> Auto-generated by `pipeline/lib/gaps.py`. Regenerated: **2026-07-13 17:31:19**.
> Source: `pipeline-state/gaps/<slug>.md` (written by integrate/verify stages).

| Bucket | Markers | Count |
|---|---|--:|
| docs-mcp | coverageGap / staleness / docsEscape | 1 / 2 / 1 |
| skills | missedTrigger / falseTrigger / variant / hallucination | 6 / 0 / 0 / 0 |
