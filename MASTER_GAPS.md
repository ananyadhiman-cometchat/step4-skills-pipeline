...
> Auto-generated by `pipeline/lib/gaps.py`. Regenerated: **2026-07-20 13:59:18**.
> Source: `pipeline-state/gaps/<slug>.md` (written by integrate/verify stages).

| Bucket | Markers | Count |
|---|---|--:|
| docs-mcp | coverageGap / staleness / docsEscape | 4 / 5 / 4 |
| skills | missedTrigger / falseTrigger / variant / hallucination | 14 / 1 / 0 / 2 |
| sdk | SDK-gap (packaging / behaviour) | 19 |
