...
> Auto-generated by `pipeline/lib/gaps.py`. Regenerated: **2026-07-21 14:34:15**.
> Source: `pipeline-state/gaps/<slug>.md` (written by integrate/verify stages).

| Bucket | Markers | Count |
|---|---|--:|
| docs-mcp | coverageGap / staleness / docsEscape | 5 / 5 / 4 |
| skills | missedTrigger / falseTrigger / variant / hallucination | 15 / 1 / 0 / 2 |
